...
namespace JeuWithGuigui3
{
    ...
    class Dwarf : Race
    {
        private static readonly string proprties1 = "+50 HP";
        private static readonly string proprties2 = "+5 Classic Damage";
        private static readonly string proprties3 = "Start the game with a Medium Armor";
    ...
    {
        private static readonly string proprties1 = "+30 Magic damage";
